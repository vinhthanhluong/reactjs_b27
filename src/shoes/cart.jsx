      ...
      <div className="relative h-full w-full max-w-2xl max-h-full">
        <div className="relative h-full bg-white rounded-lg shadow-sm ">
          ...
          <div className="p-4 md:p-5 space-y-4 overflow-auto max-h-[720px]">
            <div className="relative flex flex-col bg-white border border-gray-200 rounded-lg shadow-sm md:flex-row">
              <button
                type="button"
                className="absolute top-[10px] right-[10px] text-red-400 bg-transparent hover:text-red-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center"
              >
                <svg
                  className="w-3 h-3"
                  aria-hidden="true"
              ...
              <div className="flex flex-col p-4 pr-10 leading-normal">
                ...
                <p className="text-xl font-medium mb-2">123$</p>
                <div className="flex items-center">
                  <button className="w-[30px] h-[30px] flex items-center justify-center pb-1 border border-black text-black rounded-md disabled:bg-gray-200">
                    -
                  </button>
                  <span className="mx-2">1</span>
                  <button className="w-[30px] h-[30px] flex items-center justify-center pb-1  border border-black text-black rounded-md">
                    +
                  </button>
                </div>
              </div>
